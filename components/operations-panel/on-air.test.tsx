...
describe("OperationsPanelOnAir", () => {
  ...
  it("renders 0% progress when elapsed is 0", () => {
    mockUseActiveBlock.mockReturnValue(makeSnapshot({ elapsedInBlock: 0, durationSeconds: 3600 }))
    render(renderWithIntl(<OperationsPanelOnAir />))
  ...
  it("renders elapsed and total duration timecodes", () => {
    ...
    mockUseActiveBlock.mockReturnValue(makeSnapshot({ elapsedInBlock: 90, durationSeconds: 3600 }))
    render(renderWithIntl(<OperationsPanelOnAir />))
