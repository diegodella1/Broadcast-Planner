...
function EventSlideInner({
  ...
  if (eventCount === 1) return <SingleEventCard event={selectedEvents[0]!} />
...
export const EventSlide = memo(EventSlideInner, (prev, next) => {
  if (prev.eventSlideStyle !== next.eventSlideStyle) return false
  if (prev.layoutOrientation !== next.layoutOrientation) return false
