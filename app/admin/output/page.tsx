                        ...
                        <div className="flex flex-wrap items-start justify-between gap-4">
                            <div className="min-w-0">
                                ...
                                <p className="mt-2 max-w-2xl text-sm leading-6 text-muted">
                                    Open this page on the capture machine, click Start Output once,
                                    then capture the browser window in OBS/vMix.
                                </p>
                            </div>
                    ...
                    <ControlSection title="Reuters source">
                        <form action={setReutersOverride} className="grid gap-2">
                            ...
                            <input
                                ...
                                className="border border-line px-2 py-1 text-xs text-ink"
                            />
                            <button className="btn-secondary min-h-8 px-2 text-xs">
                                Set Reuters live
                            </button>
                        </form>
                        {outputOverride ? (
