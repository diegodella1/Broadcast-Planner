      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
        <section className="surface-panel p-5">
          ...
          <section className="mt-6 rounded-md bg-panel p-4">
            ...
            <p className="mt-1 text-sm text-zinc-700">{asset?.title ?? "No asset assigned"}</p>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  Ready music tracks flow across slide, image and visual fallback blocks. Video, ad,
                  promo and live media pause the playlist.
                </p>
              </div>
