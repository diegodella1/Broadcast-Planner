...
export default async function OutputLivePage({ searchParams }: { searchParams: Promise<{ debug?: string; startAt?: string }> }) {
  ...
  return <OutputRenderer initialSchedule={schedule} initialSeconds={Number.isFinite(startAt) ? startAt! : secondsSinceMidnightInTimezone()} debug={params.debug === "true"} />
}
