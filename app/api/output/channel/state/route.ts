            ...
            return NextResponse.json(
                {
                    ...
                    title:
                        metadataText(active.block.metadata, 'reuters_stream_label') ||
                        active.block.title,
                    hlsUrl: reutersUrl,
                    startOffsetSeconds: 0,
                    ...
                    sourceType: 'reuters',
                    streamProtocol:
                        metadataText(active.block.metadata, 'reuters_stream_protocol') || 'hls',
                    backgroundMusic: suppressBackgroundMusic(music),
                },
                { headers: { 'Cache-Control': 'no-store' } },
            );
                ...
                return NextResponse.json(
                    {
                        ...
                        startOffsetSeconds,
                        durationSeconds:
                            active.asset.durationSeconds ?? active.block.durationSeconds,
                        ...videoPresentation(active.asset),
                        ...recordedBugPresentation(active.block),
                        backgroundMusic: suppressBackgroundMusic(music),
                    },
